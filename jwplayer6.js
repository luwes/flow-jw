if (typeof jwplayer == "undefined") {
    ...
    (function (d) {
        ...
        k.getAbsolutePath = function (r, q) {
            if (!k.exists(q)) {
                q = j.location.href
            }
            if (!k.exists(r)) {
            ...
            var s = q.substring(0, q.indexOf("://") + 3);
            var p = q.substring(s.length, q.indexOf("/", s.length + 1));
            var m;
            if (r.indexOf("/") === 0) {
                m = r.split("/")
            } else {
                var n = q.split("?")[0];
                n = n.substring(s.length + p.length + 1, n.lastIndexOf("/"));
                m = n.split("/")
                    .concat(r.split("/"))
            }
            var l = [];
            for (var o = 0; o < m.length; o++) {
                if (!m[o] || !k.exists(m[o]) || m[o] == ".") {
                    continue
                } else {
                    if (m[o] == "..") {
                        l.pop()
        ...
        var e = k.userAgentMatch = function (m) {
            var l = b.userAgent.toLowerCase();
            return (l.match(m) !== null)
        };
        k.isIE = function () {
            return e(/msie/i)
        };
        ...
        k.isIPod = function () {
            return e(/iP(hone|od)/i)
        };
        k.isIPad = function () {
            return e(/iPad/i)
        };
        k.saveCookie = function (l, m) {
            j.cookie = "jwplayer." + l + "=" + m + "; path=/"
        };
        k.getCookies = function () {
            var o = {};
            var n = j.cookie.split("; ");
            for (var m = 0; m < n.length; m++) {
                var l = n[m].split("=");
                if (l[0].indexOf("jwplayer.") == 0) {
                    o[l[0].substring(9, l[0].length)] = l[1]
                }
            }
            return o
        };
        k.typeOf = function (m) {
            ...
            if (l === "object") {
                ...
                return (m instanceof Array) ? "array" : l
            } else {
                return l
            }
        };
        k.translateEventResponse = function (n, l) {
            var p = k.extend({}, l);
            if (n == d.events.JWPLAYER_FULLSCREEN && !p.fullscreen) {
                ...
                if (typeof p.data == c) {
                    ...
                    if (typeof p.metadata == c) {
                        k.deepReplaceKeyName(p.metadata, ["__dot__", "__spc__", "__dsh__"], [".", " ", "-"])
                    }
                }
            }
            var m = ["position", "duration", "offset"];
            for (var o in m) {
                if (p[m[o]]) {
                    p[m[o]] = Math.round(p[m[o]] * 1000) / 1000
                }
            }
            return p
        };
        k.flashVersion = function () {
            ...
            if (l != h) {
                m = l["Shockwave Flash"];
                if (m) {
                    return parseInt(m.description.replace(/\D+(\d+)\..*/, "$1"))
                }
            }
            if (typeof g.ActiveXObject != h) {
                try {
                    ...
                    if (m) {
                        return parseInt(m.GetVariable("$version")
                            .split(" ")[1].split(",")[0])
                    }
                } catch (n) {}
            }
        ...
        k.getScriptPath = function (n) {
            var l = j.getElementsByTagName("script");
            for (var m = 0; m < l.length; m++) {
                var o = l[m].src;
                if (o && o.indexOf(n) >= 0) {
                    return o.substr(0, o.indexOf(n))
                }
            }
            return ""
        };
        k.deepReplaceKeyName = function (s, n, l) {
            switch (d.utils.typeOf(s)) {
            case "array":
                for (var p = 0; p < s.length; p++) {
                    s[p] = d.utils.deepReplaceKeyName(s[p], n, l)
                }
                break;
            case c:
                for (var o in s) {
                    var r, q;
                    if (n instanceof Array && l instanceof Array) {
                    ...
                    for (var p = 0; p < r.length; p++) {
                        m = m.replace(new RegExp(n[p], "g"), l[p])
                    }
                    s[m] = d.utils.deepReplaceKeyName(s[o], n, l);
                    if (o != m) {
                        delete s[o]
                    }
                }
        ...
        k.getPluginPathType = function (m) {
            if (typeof m != f) {
                return
            }
            m = m.split("?")[0];
            ...
            var l = m.indexOf("/");
            var o = k.extension(m);
            if (n < 0 && l < 0 && (!o || !isNaN(o))) {
                return i.CDN
            }
            return i.RELATIVE
        };
        k.getPluginName = function (l) {
            return l.replace(/^.*\/([^-]*)-?.*\.(swf|js)$/, "$1")
        };
        k.getPluginVersion = function (l) {
            return l.replace(/[^-]*-?([^\.]*).*$/, "$1")
        };
        k.isYouTube = function (l) {
            return (l.indexOf("youtube.com") > -1 || l.indexOf("youtu.be") > -1)
        };
        k.isRtmp = function (l, m) {
            return (l.indexOf("rtmp") == 0 || m == "rtmp")
        };
    ...
    (function (n) {
        ...
        a.extType = function (o) {
            return a.mimeType(h[o])
        }
    })(jwplayer.utils);
    (function (b) {
    ...
    (function (a) {
        ...
        a.extension = function (b) {
            ...
            b = b.substring(b.lastIndexOf("/") + 1, b.length)
                .split("?")[0].split("#")[0];
            if (b.lastIndexOf(".") > -1) {
                return b.substr(b.lastIndexOf(".") + 1, b.length)
                    .toLowerCase()
            }
        };
    ...
    (function (a) {
        ...
        a.plugins.registerPlugin = function (g, f, e) {
            var d = a.utils.getPluginName(g);
            if (!c[d]) {
                c[d] = new a.plugins.plugin(g)
            }
            c[d].registerPlugin(g, f, e)
        }
    })(jwplayer);
    (function (a) {
        ...
        b.plugin = function (e) {
            ...
            this.load = function () {
                if (k == a.loaderstatus.NEW) {
                    ...
                    var n = new a.scriptloader(g());
                    n.addEventListener(c.COMPLETE, i);
                    n.addEventListener(c.ERROR, h);
                    n.load()
                }
            };
            this.registerPlugin = function (p, o, n) {
                if (m) {
                    clearTimeout(m);
                    m = undefined
                }
            ...
            this.getFlashPath = function () {
                if (l) {
                    ...
                    case a.pluginPathType.RELATIVE:
                        if (e.lastIndexOf(".swf") > 0) {
                            return a.getAbsolutePath(l, window.location.href)
                        }
                        return a.getAbsolutePath(l, g())
                    }
                }
                return null
            };
            ...
            this.getNewInstance = function (o, n, p) {
                return new j(o, n, p)
            };
    ...
    (function (b) {
        var a = b.utils,
            c = b.events;
        b.plugins.pluginloader = function (i, g) {
            ...
            function l() {
                if (!d) {
                    var p = 0,
                        o = i.getPlugins();
                    for (plugin in o) {
                        var n = o[plugin].getStatus();
                        if (n == a.loaderstatus.LOADING || n == a.loaderstatus.NEW) {
                            p++
                        }
                    }
                    if (p == 0) {
            ...
            this.setupPlugins = function (u, q, w) {
                var p = {
                    length: 0,
                    plugins: {}
                }, s = {
                ...
                for (var t in r) {
                    var x = r[t],
                        ...
                        n = x.getURL();
                    if (y) {
                        p.plugins[y] = a.extend({}, q.plugins[n]);
                        p.plugins[y].pluginmode = x.getPluginmode();
                        p.length++
                    }
                    if (z) {
                        ...
                        o.style.zIndex = s.length + 10;
                        s.plugins[v] = x.getNewInstance(u, a.extend({}, q.plugins[n]), o);
                        s.length++;
                        u.onReady(w(s.plugins[v], o, true));
                        u.onResize(w(s.plugins[v], o))
                    }
                }
                u.plugins = s.plugins;
                return p
            ...
            this.load = function () {
                if (a.exists(g) && a.typeOf(g) != "object") {
                    l();
                    return
                }
                ...
                for (var o in g) {
                    if (a.exists(o)) {
                        var p = i.addPlugin(o);
                        p.addEventListener(c.COMPLETE, l);
                        p.addEventListener(c.ERROR, j)
                    }
                }
                var n = i.getPlugins();
                for (o in n) {
    ...
    (function (b) {
        var a = b.utils,
            c = b.events;
        var d = b.embed = function (o) {
            var l = new d.config(o.config),
                h, j = "Error loading player: ",
                g = b.plugins.loadPlugins(o.id, l.plugins);
            l.id = o.id;
            ...
            function e() {
                if (a.typeOf(l.playlist) == "array" && l.playlist.length < 2) {
                    if (l.playlist.length == 0 || !l.playlist[0].sources || l.playlist[0].sources.length == 0) {
                        m();
                        return
                    }
                }
                if (g.getStatus() == a.loaderstatus.COMPLETE) {
                    for (var r = 0; r < l.modes.length; r++) {
                        if (l.modes[r].type && d[l.modes[r].type]) {
                            var s = l.modes[r].config;
                            var p = a.extend({}, s ? d.config.addConfig(l, s) : l);
                            var q = new d[l.modes[r].type](h, l.modes[r], p, g, o);
                            if (q.supportsConfig()) {
                                q.addEventListener(c.ERROR, f);
                                q.embed();
                                i(o, p.events);
                                return o
                            }
            ...
            function k(p) {
                n(h, j + "Could not load plugins")
            }
            function m() {
                n(h, j + "No media sources found")
            }
            function n(p, r) {
                if (!l.fallback) {
                    return
                ...
                q.color = "#FFF";
                q.width = a.styleDimension(l.width);
                q.height = a.styleDimension(l.height);
                q.display = "table";
                ...
                s.font = "15px/20px Arial, Helvetica, sans-serif";
                t.innerHTML = r.replace(":", ":<br>");
                p.innerHTML = "";
                p.appendChild(t)
            }
            b.embed.errorScreen = n;
            g.addEventListener(c.COMPLETE, e);
            g.addEventListener(c.ERROR, k);
            g.load();
            return o
        }
    })(jwplayer);
    ...
    (function (e) {
        ...
        g.download = function (n, y, l) {
            ...
            function x() {
                ...
                if (C && C.length) {
                    ...
                    for (G = 0; G < B.length; G++) {
                        var A = B[G],
                            H = A.type ? A.type : j.extensionmap.extType(j.extension(A.file));
                        if (A.file) {
                            if (("mp4,flv,webm,aac,mp3,vorbis")
                                .split(",")
                                .indexOf(H) > -1) {
                                E = A.file;
                                F = I.image;
            ...
            function p() {
                ...
                w(A + "display", {
                    width: j.styleDimension(Math.max(300, o)),
                    height: j.styleDimension(Math.max(200, r)),
            ...
            function m(A) {
                var B = v("embed", "", n);
                B.src = "http://www.youtube.com/v/" + (/v[=\/](\w*)|\/(\w+)$|^(\w+)$/i)
                    .exec(A)
                    .slice(1)
                    .join("");
    ...
    (function (c) {
        ...
        var e = c.embed.flash = function (l, m, q, k, o) {
            ...
            this.embed = function () {
                ...
                a[l.id] = n(x);
                if (b.isIE()) {
                    var B = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" bgcolor="' + E + '" width="100%" height="100%" id="' + l.id + '" name="' + l.id + '" tabindex=0"">';
        ...
        c.embed.html5 = function (g, h, o, f, k) {
            ...
            j.embed = function () {
                if (c.html5) {
                    ...
                    if (p.skin && p.skin.toLowerCase()
                        .indexOf(".zip") > 0) {
                        p.skin = p.skin.replace(/\.zip/i, ".xml")
                    }
            ...
            function m(p) {
                ...
                try {
                    if (q.canPlayType(p)) {
                        ...
                        if (p == "audio/mp3" && navigator.userAgent.match(/safari/i)) {
                            return q.canPlayType("audio/mpeg")
                        } else {
                            return false
                        }
                    }
    ...
    (function (d) {
        ...
        var f = d.api = function (s) {
            ...
            w.container = s;
            w.id = s.id;
            w.getBuffer = function () {
                return v("jwGetBuffer")
            };
            w.getContainer = function () {
                return w.container
            };
            w.addButton = function (G, E, F, J) {
                try {
                    m[J] = F;
                    var I = "jwplayer('" + w.id + "').callback('" + J + "')";
                    v("jwDockAddButton", G, E, I, J)
                } catch (H) {
                    a.log("Could not add dock button" + H.message)
                }
            };
            w.removeButton = function (E) {
                v("jwDockRemoveButton", E)
            }, w.callback = function (E) {
                if (m[E]) {
                    m[E]()
                }
            };
            w.getDuration = function () {
                return v("jwGetDuration")
            };
            w.getFullscreen = function () {
                return v("jwGetFullscreen")
            };
            w.getStretching = function () {
                return v("jwGetStretching")
            };
            w.getHeight = function () {
                return v("jwGetHeight")
            };
            w.getLockState = function () {
                return v("jwGetLockState")
            };
            w.getMeta = function () {
                return w.getItemMeta()
            };
            w.getMute = function () {
                return v("jwGetMute")
            };
            w.getPlaylist = function () {
                var F = v("jwGetPlaylist");
                if (w.renderingMode == "flash") {
                    a.deepReplaceKeyName(F, ["__dot__", "__spc__", "__dsh__"], [".", " ", "-"])
                }
                for (var E = 0; E < F.length; E++) {
                    if (!a.exists(F[E].index)) {
                        F[E].index = E
                    }
                }
                return F
            };
            w.getPlaylistItem = function (E) {
                if (!a.exists(E)) {
                    E = w.getCurrentItem()
                }
                return w.getPlaylist()[E]
            };
            w.getPosition = function () {
                return v("jwGetPosition")
            };
            w.getRenderingMode = function () {
                return w.renderingMode
            };
            w.getState = function () {
                return v("jwGetState")
            };
            w.getVolume = function () {
                return v("jwGetVolume")
            };
            w.getWidth = function () {
                return v("jwGetWidth")
            };
            w.setFullscreen = function (E) {
                if (!a.exists(E)) {
                    v("jwSetFullscreen", !v("jwGetFullscreen"))
                } else {
                    v("jwSetFullscreen", E)
                }
                return w
            };
            w.setStretching = function (E) {
                v("jwSetStretching", E);
                return w
            };
            w.setMute = function (E) {
                if (!a.exists(E)) {
                    v("jwSetMute", !v("jwGetMute"))
                } else {
                    v("jwSetMute", E)
                }
                return w
            ...
            w.playlistItem = function (E) {
                v("jwPlaylistItem", parseInt(E));
                return w
            };
            w.playlistPrev = function () {
                v("jwPlaylistPrev");
                return w
            };
            w.playlistNext = function () {
                v("jwPlaylistNext");
                return w
            };
            w.resize = function (F, E) {
                if (w.renderingMode == "html5") {
                    h.jwResize(F, E)
                } else {
                    var G = document.getElementById(w.id + "_wrapper");
                    if (G) {
                        G.style.width = a.styleDimension(F);
                        G.style.height = a.styleDimension(E)
                    }
                }
                return w
            };
            ...
            w.loadInstream = function (F, E) {
                x = new f.instream(this, h, F, E);
                return x
            };
            w.getQualityLevels = function () {
                return v("jwGetQualityLevels")
            };
            w.getCurrentQuality = function () {
                return v("jwGetCurrentQuality")
            };
            w.setCurrentQuality = function (E) {
                v("jwSetCurrentQuality", E)
            };
            w.getCaptionsList = function () {
                return v("jwGetCaptionsList")
            };
            w.getCurrentCaptions = function () {
                return v("jwGetCurrentCaptions")
            };
            w.setCurrentCaptions = function (E) {
                v("jwSetCurrentCaptions", E)
            };
            w.getControls = function () {
                return v("jwGetControls")
            };
            w.getSafeRegion = function () {
                return v("jwGetSafeRegion")
            };
            w.setControls = function (E) {
                v("jwSetControls", E)
            };
            var q = {
            ...
            w.setup = function (E) {
                if (d.embed) {
                    ...
                    var F = d(w.id);
                    F.config = E;
                    return new d.embed(F)
                }
                return w
            };
            w.registerPlugin = function (G, F, E) {
                d.plugins.registerPlugin(G, F, E)
            };
            w.setPlayer = function (E, F) {
                h = E;
                w.renderingMode = F
            };
            w.detachMedia = function () {
                if (w.renderingMode == "html5") {
                    return v("jwDetachMedia")
                }
            };
            w.attachMedia = function () {
                if (w.renderingMode == "html5") {
                    return v("jwAttachMedia")
                }
            };
            ...
            function i(E, F) {
                try {
                    E.jwAddEventListener(F, 'function(dat) { jwplayer("' + w.id + '").dispatchEvent("' + F + '", dat); }')
                } catch (G) {
            ...
            w.dispatchEvent = function (G) {
                if (g[G]) {
                    var F = a.translateEventResponse(G, arguments[1]);
                    for (var E = 0; E < g[G].length; E++) {
                        if (typeof g[G][E] == "function") {
                            g[G][E].call(this, F)
                        }
                    }
                }
            };
            w.dispatchInstreamEvent = function (E) {
                if (x) {
                    x.dispatchEvent(E, arguments)
                }
            };
            ...
            function v() {
                if (C) {
                    ...
                    if (typeof h != "undefined" && typeof h[G] == "function") {
                        switch (E.length) {
                        case 4:
                            return (h[G])(E[0], E[1], E[2], E[3]);
                        case 3:
                            return (h[G])(E[0], E[1], E[2]);
                        case 2:
                            return (h[G])(E[0], E[1]);
                        case 1:
                            return (h[G])(E[0]);
            ...
            w.playerReady = function (E) {
                C = true;
                if (!h) {
                    w.setPlayer(document.getElementById(E.id))
                }
                w.container = document.getElementById(w.id);
                a.foreach(g, function (F) {
                    i(h, F)
                });
                y(e.JWPLAYER_PLAYLIST_ITEM, function (F) {
                    r = {}
                });
                y(e.JWPLAYER_MEDIA_META, function (F) {
                    a.extend(r, F.metadata)
                });
                w.dispatchEvent(e.API_READY);
                while (o.length > 0) {
                    v.apply(this, o.shift())
                }
            };
            w.getItemMeta = function () {
                return r
            };
            w.getCurrentItem = function () {
                return v("jwGetPlaylistIndex")
            };
        ...
        f.selectPlayer = function (h) {
            ...
            if (g) {
                var i = f.playerById(g.id);
                if (i) {
                    return i
                } else {
                    return f.addPlayer(new f(g))
                }
            } else {
                if (typeof h == "number") {
                    return c[h]
        ...
        f.destroyPlayer = function (i) {
            ...
            if (h >= 0) {
                var l = c[h].id,
                    g = document.getElementById(l + "_wrapper");
                if (g) {
        ...
        d.playerReady = function (h) {
            var g = d.api.playerById(h.id);
            if (g) {
                g.playerReady(h)
            } else {
                d.api.selectPlayer(h.id)
                    .playerReady(h)
            }
        }
    })(jwplayer);
