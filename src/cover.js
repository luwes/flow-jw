...
function Cover(flow, index, url, duration, coverWidth, coverHeight, reflectOpacity,
...
Cover.prototype.reflect = function(bitmap, wid, hei, reflectOpacity, reflectRatio, reflectOffset) {
